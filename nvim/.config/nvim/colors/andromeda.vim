...
" basic
call s:hi('Normal', s:fg15, s:bg0, s:none)
call s:hi('Comment', s:fg14, s:bg0, s:none)
...
" delimiters
call s:hi('Delimiter', s:fg14, s:bg0, s:bold)
...
" line numbers
call s:hi('LineNr', s:fg8, s:bg0, s:none)
if has('nvim')
    call s:hi('CursorLineNr', s:fg14, s:bg0, s:none)
else
    call s:hi('CursorLineNr', s:fg8, s:bg0, s:none)
endif

" error messages
call s:hi('ErrorMsg', s:fg9, s:bg0, s:none)
...
call s:hi('FoldColumn', s:fg6, s:bg0, s:none)
...
" basic syntax
call s:hi('Constant', s:fg6, s:bg0, s:none)
call s:hi('String', s:fg10, s:bg0, s:none)
call s:hi('Number', s:fg6, s:bg0, s:none)
...
" identifiers
call s:hi('Identifier', s:fg7, s:bg0, s:none)
call s:hi('Function', s:fg12, s:bg0, s:bold)

" statements
call s:hi('Statement', s:fg10, s:bg0, s:bold)
call s:hi('Conditional', s:fg10, s:bg0, s:bolditalic)
call s:hi('Label', s:fg5, s:bg0, s:none)
call s:hi('Exception', s:fg9, s:bg0, s:italic)
hi link Repeat Conditional

call s:hi('PreProc', s:fg13, s:bg0, s:bolditalic)
...
" types
call s:hi('Type', s:fg13, s:bg0, s:none)
call s:hi('StorageClass', s:fg13, s:bg0, s:italic)
call s:hi('Structure', s:fg5, s:bg0, s:bold)
call s:hi('Typedef', s:fg13, s:bg0, s:none)

" special
call s:hi('Special', s:fg11, s:bg0, s:bold)
call s:hi('SpecialChar', s:fg11, s:bg0, s:bold)
call s:hi('Tag', s:fg11, s:bg0, s:bold)
call s:hi('SpecialComment', s:fg13, s:bg0, s:bold)
call s:hi('Debug', s:fg1, s:bg0, s:bold)
...
call s:hi('pythonStatement', s:fg10, s:bg0, s:bold)
call s:hi('pythonOperator', s:fg14, s:bg0, s:bold)
call s:hi('pythonSpaceError', s:fg8, s:bg0, s:inverse)
call s:hi('pythonAttribute', s:fg14, s:bg0, s:inverse)
call s:hi('pythonSelf', s:fg5, s:bg0, s:italic)

" javascript/typescript
call s:hi('xmlAttrib', s:fg5, s:bg0, s:none)
hi link javaScriptIdentifier TypeDef
hi link xmlTagName Tag
hi link jsReturn Function

" latex/lilypond
call s:hi('lilyKeyword', s:fg11, s:bg0, s:none)
call s:hi('texSection', s:fg12, s:bg0, s:none)
call s:hi('texInputFile', s:fg10, s:bg0, s:none)

" vimscript
call s:hi('vimCommand', s:fg11, s:bg0, s:bold)
